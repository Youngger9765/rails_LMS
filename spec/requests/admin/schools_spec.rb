...
RSpec.describe "/admin/schools", type: :request do
  ...
  describe "GET /index" do
    it "renders a successful response" do
      Admin::School.create! valid_attributes
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Admin::School" do
        expect {
          post admin_schools_url, params: { admin_school: valid_attributes }
        }.to change(Admin::School, :count).by(1)
      end

      it "redirects to the created admin_school" do
        post admin_schools_url, params: { admin_school: valid_attributes }
        expect(response).to redirect_to(admin_school_url(@admin_school))
      end
    end

    context "with invalid parameters" do
      it "does not create a new Admin::School" do
        expect {
          post admin_schools_url, params: { admin_school: invalid_attributes }
        }.to change(Admin::School, :count).by(0)
      end
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested admin_school" do
        school = Admin::School.create! valid_attributes
        patch admin_school_url(admin_school), params: { admin_school: new_attributes }
        school.reload
      ...
      it "redirects to the admin_school" do
        ...
        patch admin_school_url(admin_school), params: { admin_school: new_attributes }
        school.reload
        expect(response).to redirect_to(admin_school_url(school))
      end
    end
    ...
    context "with invalid parameters" do
      it "renders a successful response (i.e. to display the 'edit' template)" do
        school = Admin::School.create! valid_attributes
        patch admin_school_url(admin_school), params: { admin_school: invalid_attributes }
        expect(response).to be_successful
      end
    end
  end
